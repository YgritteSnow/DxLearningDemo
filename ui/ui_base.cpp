...
void UIBase::RecalMatrix()
{
	...
	//trans_mat._11 = g_screen_real_width * 0.5f;
	//trans_mat._22 = g_screen_real_height * 0.5f;
	//trans_mat._33 = 1.1f;
	//trans_mat._34 = 1.f;
	//trans_mat._44 = 0.0f;

	//第三种，用函数做投影矩阵。。。
	//D3DXMatrixOrthoLH( &trans_mat, g_screen_real_width * 1.f, g_screen_real_height * 0.8f, 1 + 0.01f, 1 );
	//D3DXMatrixInverse( &trans_mat, NULL, &trans_mat );

	//第四种，要加上位置属性了，还是自己做矩阵吧~
	D3DXMatrixIdentity( &trans_mat );
