...
void UIBase::PreRender( LPDIRECT3DDEVICE9 device )
{
	...
	v_arr[0] = UIVertex( -0.5f, -0.5f, 0.f, 0xffffffff, 0.f, 0.f );
	v_arr[1] = UIVertex( 0.5f, 0.5f, 0.f, 0xffffffff, 1.f, 1.f );
	v_arr[2] = UIVertex( -0.5f, 0.5f, 0.f, 0xffffffff, 0.f, 1.f );

	v_arr[3] = UIVertex( -0.5f, -0.5f, 0.f, 0xffffffff, 0.f, 0.f );
	v_arr[4] = UIVertex( 0.5f, -0.5f, 0.f, 0xffffffff, 1.f, 0.f );
	v_arr[5] = UIVertex( 0.5f, 0.5f, 0.f, 0xffffffff, 1.f, 1.f );
...
void UIBase::RecalMatrix()
{
	...
	D3DXMatrixTranslation( &trans_mat, 0, 0, g_zmin + 0.1f );
	const D3DXMATRIX* view_mat = ModelManager::GetInvCameraMatrix();

	D3DXMATRIX scale_mat;
	D3DXMatrixScaling( &scale_mat, g_screen_real_width * 0.5f, g_screen_real_height * 0.5f, 1.f );
