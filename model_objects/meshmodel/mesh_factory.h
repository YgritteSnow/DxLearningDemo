#ifndef __F__MYPROJECTS_DXDEMO_1_DXDEMO_1__MODEL_OBJECTS_MESHMODEL_MESH_FACTORY_H__
#define __F__MYPROJECTS_DXDEMO_1_DXDEMO_1__MODEL_OBJECTS_MESHMODEL_MESH_FACTORY_H__
...
void PaintMesh( VertexStruct*& vbuffer, const int& vcount )
{
	...
	{
		vbuffer[i]._color = (( DWORD(rand()) << 8) + 0x000000ff);
	}
}
